...
3. Inside the php.ini find extension=php_soap.dll on php.ini and uncomment it. Take note, in updated version of Xampp, the 4. extension=php_soap.dll will be extension=php_soap. This will enable the soap functionality in php.
