                    	    ...
                    	    <div class="col-lg-12">
                                <div class="portlet">          
                                    <div id="bg-primary1" class="panel-collapse collapse in">
                                           <marquee behavior="alternate" direction="left" style="font-weight: bold; margin-top:0.5%;">Welcome to FVR B2B Portal ! System updates: Ferry Bookings Sidebar Menu now functional !</marquee>                                         
                                    </div>
                                </div>
                            </div>
                            <!-- end col -->
                                ...
                                <div class="portlet">
                                    <div id="bg-primary1" class="panel-collapse collapse in">
                                        <div class="portlet-body">                                          
                                           <b>Our Hotline Numbers: TELEPHONE :</b> (085)-8153332 | <b>MOBILE (Globe) :</b> 09274214055 | <b>MOBILE (Smart) :</b> 0947-829-2958
                                        </div>
                                    </div>
                                </div>
                            </div>
				...
				<div class="modal fade" id="2goModal" role="dialog" tabindex="-1">
					...
					<!-- Modal content-->
						<div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal">&times;</button>
								<h4 class="modal-title"><b>Ferry Bookings</b></h4>
							</div>
							<div class="modal-body">
								<div class="row">
									<div class="col-md-6">
